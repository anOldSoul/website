  ...
  <div class="page-content">
    ...
    <el-card class="page-content">
      ...
      <el-row>
        ...
        <el-col :span="7">
          <el-input v-model="formData.lockname" clearable placeholder="请输入设备名称"/>
        </el-col>
        <el-col :span="3" :push="1">绑定网关</el-col>
        <el-col :span="8" :push="1">
          <el-input v-model="formData.gateid" disabled clearable placeholder="请输入绑定网关"/>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="3">设备编号</el-col>
        <el-col :span="7">
          <el-input v-model="formData.lockid" disabled clearable placeholder="请输入设备编号"/>
        </el-col>
        <el-col :span="3" :push="1">设备位置</el-col>
        <el-col :span="8" :push="1">
          <el-input v-model="formData.lockaddr" clearable placeholder="请输入设备位置"/>
        </el-col>
      </el-row>
      <el-row>
    ...
    <el-card class="page-content">
      ...
      <el-table :data="formData.tUseInfoList" style="width: 100%">
        ...
        <el-table-column label="操作" width="160" class-name="cell-cneter" fixed="right">
          <template slot-scope="scope">
            <div class="opertion">
              <el-button v-if="scope.row.pwtype !== '01'" :disabled="scope.row.changetype !== '1' && scope.row.changetype !== '3'" type="primary" size="mini" @click="handlePwStats(scope.row)">
    ...
    <el-dialog :visible.sync="dialogTableVisible" title="新增密钥">
      <el-form :model="form">
        <el-form-item :label-width="formLabelWidth" label="用户名">
          <el-input v-model="form.username" auto-complete="off" class="dialog-input"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="用户类型">
          <el-select v-model="form.usertype" placeholder="请选择用户类型">
            <el-option label="普通用户" value="00"/>
            <el-option label="管理员" value="01"/>
          </el-select>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="密码类型">
        ...
        <el-form-item v-if="form.pwtype !== '03'" :label="form.pwtype === '03' ? '卡号' : '密码'" :label-width="formLabelWidth">
          <el-input v-model="form.pwd" :maxlength="pwtypeLengthStr[form.pwtype]" clearable class="dialog-input"/>
          <span v-if="form.pwtype">*长度必须为{{ pwtypeLengthStr[form.pwtype] }}位</span>
        </el-form-item>
        <el-form-item v-if="form.pwtype === '01'" :label-width="formLabelWidth" label="时限">
          <el-select v-model="form.validate" placeholder="请选择时限">
            <el-option label="3分钟" value="00"/>
            <el-option label="30分钟" value="01"/>
            <el-option label="4小时" value="02"/>
            <el-option label="24小时" value="03"/>
          </el-select>
        </el-form-item>
      </el-form>
