  ...
  <div class="page-content">
    ...
    <el-card class="page-content">
      ...
      <el-row>
        ...
        <el-col :span="5" :push="1">
          <el-select v-model="formData.floor" clearable placeholder="请选择所在楼层">
            <el-option v-for="item in floor" :label="`${item}楼`" :value="item" :key="item"/>
          </el-select>
        </el-col>
        <el-col :span="2" :push="2">房间号</el-col>
        <el-col :span="5" :push="2">
          <el-input v-model="formData.roomname" placeholder="请输入房间号"/>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="13">
          <el-input v-model="formData.roomaddr" type="textarea"/>
        </el-col>
      </el-row>
      <el-row v-if="formData.roomstat === '02'">
        <el-col :span="2">租户名</el-col>
        <el-col :span="5">
          <el-input v-model="formData.rentname" class="dialog-input" auto-complete="off"/>
        </el-col>
        <el-col :span="2" :push="1">开始时间</el-col>
        <el-col :span="5" :push="1">
          <el-date-picker v-model="formData.begintime" type="date" placeholder="选择日期"/>
        </el-col>
    ...
    <el-card class="page-content" style="margin-bottom: 100px !important;">
      ...
      <el-col v-for="(device, deviceIndex) in formData.lockInfo" :key="deviceIndex" :span="6">
        <el-card :body-style="{ padding: '0px' }" class="deviceItem">
          <img src="../../assets/pic-lock.png" class="image">
          <div style="padding: 14px;">
            <el-tooltip :content="device.lockname" class="item" effect="dark" placement="top-start">
    ...
    <el-dialog :visible.sync="dialogTableVisible" title="请选择要添加的设备">
      <el-table :data="gridData">
        <el-table-column property="lockname" label="设备名称" width="150"/>
        <el-table-column property="gateid" label="绑定网关" width="200"/>
        <el-table-column property="electricity" label="电量"/>
